...
//A way to cleanup after yourself 2, just one line:
afterEach(cleanup)
...
/*
http://ws.kcd.im/?ws=Testing&e=login.step-3%20(renderIntoDocument)&em=37odri@gmail.com
*/
...
//how to check an internal state of a component?
//Always ask yourself: if I were a manual tester how would I test it? If I only have the interface, how would I do this?
//Rather than check the internal state ---> check whether data shows up, or sends out or spinner shows up etc. Check the things that should happen when the state changes
